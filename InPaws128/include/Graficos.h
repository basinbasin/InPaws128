...
namespace Inpaws
{
    class Graficos: public PawPart
    {
      public:
        ...
        // Complete up to numLocs-1 with empty so you don't have
        // that touch the source every time a location is added
        void completarLocalidades (SpByte numLocs, SpByte attr = 7);

        // Tamaño de todo el volcado (para luego meter en memoria en
        // la posición correcta)

        // Size of the entire dump (then put in memory in
        // the right position)
        SpWord size() const
