...
#define MSGPREP_SYSMESCPC "las versiones para SCE o para Superglus o para DSF requieren un m\241nimo de 61 mensajes del sistema"
...
#define MSGPREP_DEFCORR "couldn't establish a correlative definition for the elements"
...
#define MSGPREP_SYSMESCPC "SCE, DSF and Superglus versions require a minimum of 61 system messages defined"
