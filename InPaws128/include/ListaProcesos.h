...
namespace Inpaws
{
    class ListaProcesos: public PawPart
    {
        public:
            ...
            void generarCodigoDiscoDSF(std::ostream& os, uint16_t flags, const Vocabulario* vocabulario,
                const Diccionario::TDiccionarioInverso* diccionario = NULL);
            void generarCodigoDiscoDSFi(std::ostream& os, uint16_t flags, int i, int display, const Vocabulario* vocabulario,
                const Diccionario::TDiccionarioInverso* diccionario = NULL);
